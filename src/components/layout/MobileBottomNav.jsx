...
const MobileBottomNav = () => {
  ...
  // ==== Estilos auth (móvil) alineados con desktop ====
  const authItemBase = "w-full !justify-start !px-4 !py-3 !rounded-lg transition-all";
  const authActive = "bg-acento text-white border border-acento ring-2 ring-acento/40";
  const authOutline =
    currentTheme === "light"
      ? "bg-white border border-acento text-acento"
      : "bg-fondo border border-acento text-acento";
  // =====================================================
                  ...
                  {!usuario && (
                    <>
                      ...
                      <MainLinkButton
                        ...
                        variant="navbar"
                        className={`${authItemBase} ${
                          isActive("/login") ? authActive : authOutline
                        }`}
                      >
                        <IconUser size={20} />
                      ...
                      <MainLinkButton
                        ...
                        variant="navbar"
                        className={`${authItemBase} ${
                          isActive("/register") ? authActive : authOutline
                        } mt-1`}
                      >
                        <IconUser size={20} />
