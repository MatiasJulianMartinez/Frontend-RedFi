...
const Footer = () => {
  ...
  return (
    <footer className="bg-fondo shadow-none py-8" style={{ boxShadow: '0 -20px 25px -5px rgba(0, 0, 0, 0.1), 0 -8px 10px -6px rgba(0, 0, 0, 0.1)' }}>
      <div className="text-center text-texto">
        <p className="mb-6">© {year} <span className="font-bold text-texto">Red-Fi</span>. Todos los derechos reservados.</p>
