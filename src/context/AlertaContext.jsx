...
export const AlertaProvider = ({ children }) => {
  ...
  const mostrarError = (mensaje, opciones) =>
    mostrarAlerta(mensaje, "error", opciones);
  const mostrarExito = (mensaje, opciones) =>
    mostrarAlerta(mensaje, "exito", opciones);
  const mostrarInfo = (mensaje, opciones) =>
    mostrarAlerta(mensaje, "info", opciones);
  const mostrarAdvertencia = (mensaje, opciones) =>
    mostrarAlerta(mensaje, "advertencia", opciones);
